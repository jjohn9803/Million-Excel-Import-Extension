...
Public Class Stock_Transfer_Form
    ...
    Private Sub btnImport_Click(sender As Object, e As EventArgs) Handles btnImport.Click
        ...
        Using reader As IExcelDataReader = ExcelReaderFactory.CreateReader(stream)
            ...
            Next
            queryTable(0).add("ST ts") '0
            queryTable(0).add("stkts") '1
            queryTable(1).add("ST ts Desc")
            queryTable(1).add("stktsdet")
            queryTable(2).add("ST Stock")
            queryTable(2).add("stock")
            queryTable(3).add("ST Product Serial No")
            queryTable(3).add("prodsn")
            queryTable(4).add("ST Stock Serial No")
