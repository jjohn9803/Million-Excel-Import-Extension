...
Partial Public Class testDataSet
    ...
    Partial Public Class ProductDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddProductRow(ByVal name As String, ByVal description As String, ByVal type As String, ByVal price As Double) As ProductRow
...
Namespace testDataSetTableAdapters
    ...
    Partial Public Class ProductTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Product] WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 A"& _ 
                ...
                "ull_type = 1 AND [type] IS NULL) OR ([type] = @Original_type)) AND ((@IsNull_pri"& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Product] ([name], [description], [type], [price]) VALUES (@nam"& _ 
                "e, @description, @type, @price);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT id, name, description, type, price FROM"& _ 
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Product] SET [name] = @name, [description] = @description, [type] ="& _ 
                " @type, [price] = @price WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND"& _ 
                ...
                "l_type = 1 AND [type] IS NULL) OR ([type] = @Original_type)) AND ((@IsNull_price"& _ 
                " = 1 AND [price] IS NULL) OR ([price] = @Original_price)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT id, name, de"& _ 
                "scription, type, price FROM Product WHERE (id = @id)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Million_Excel_Import_Extension.My.MySettings.Default.testConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT id, name, description, type, price FROM dbo.Product"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As testDataSet.ProductDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As testDataSet.ProductDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As testDataSet.ProductDataTable = New testDataSet.ProductDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As testDataSet.ProductDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_id As Integer, ByVal Original_name As String, ByVal Original_description As String, ByVal Original_type As String, ByVal Original_price As Global.System.Nullable(Of Double)) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal name As String, ByVal description As String, ByVal type As String, ByVal price As Global.System.Nullable(Of Double)) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal name As String, ByVal description As String, ByVal type As String, ByVal price As Global.System.Nullable(Of Double), ByVal Original_id As Integer, ByVal Original_name As String, ByVal Original_description As String, ByVal Original_type As String, ByVal Original_price As Global.System.Nullable(Of Double), ByVal id As Integer) As Integer
            If (name Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal name As String, ByVal description As String, ByVal type As String, ByVal price As Global.System.Nullable(Of Double), ByVal Original_id As Integer, ByVal Original_name As String, ByVal Original_description As String, ByVal Original_type As String, ByVal Original_price As Global.System.Nullable(Of Double)) As Integer
            Return Me.Update(name, description, type, price, Original_id, Original_name, Original_description, Original_type, Original_price, Original_id)
        End Function
    End Class
